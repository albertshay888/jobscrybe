...
class SignIn extends React.Component{
  ...
  handleSubmit = event=>{
    ...
    if(!this.state.email||!this.state.password){
      alert("Fields are incomplete or incorrect, please re-enter your Email and password");
    } else{
      // console.log("poop");
      API.logIn({
  ...
  render(){
    ...
    return(
      ...
      <Paper className={classes.paper}>
        ...
        <img width="60%" padding="100px" src={logo} align="center" alt='Logo'/> 
        <Typography component="h1" variant="h5">
          Sign in
        </Typography>
        <form className={classes.form}>
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="email">Type your email address here</InputLabel>
